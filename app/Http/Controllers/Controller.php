...
abstract class Controller
{
     ...
     * usual unauthenticated redirect rather than a type error part-way through an action.
     *
     * Where a null user reaches a correct outcome on its own — a 403 from an ownership
